...
public class CustomerLayout extends AppLayout {
    ...
    private Div createHeader() {
        ...
        profileButton.addClickListener(event -> UI.getCurrent().navigate("customer/profile"));
        profileButton.getStyle().set("background-color", "#00FF00"); 
    ...
    private Div createDrawer() {
        ...
        menu.add(createDrawerMenuItem("Home", "/customer/home"));
        menu.add(createDrawerMenuItem("Profile", "/customer/profile"));
        menu.add(createDrawerMenuItem("TrainingsPlan", "/customer/taks"));
        menu.add(createDrawerMenuItem("NutritionPlan", "/customer/nutritionplan"));
